...
func UpdateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if orderItem.Unityprice != nil {
			updateObj = append(updateObj, bson.E{"unit_price", *&orderItem.Unityprice})
		}
...
func CreateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		order.Tabel_id = orderItemPack.Table_id
		...
		for _, orderItem := range orderItemPack.Order_items {
			...
			var num = toFixed(*orderItem.Unityprice, 2)
			orderItem.Unityprice = &num
