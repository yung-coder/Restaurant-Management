...
func UpdateTable() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if table.Number_of_guets != nil {
			updateObj = append(updateObj, bson.E{"number_of_guests", table.Number_of_guets})
		}

		if table.Tabel_number != nil {
			updateObj = append(updateObj, bson.E{"table_number", table.Tabel_number})
		}
