...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		invoiceView.Paymnet_due_date = invoice.Payment_due_date

		invoiceView.Patment_method = "null"
		if invoice.Payment_method != nil {
			invoiceView.Patment_method = *invoice.Payment_method
		}

		invoiceView.Invoice_id = invoice.Invoice_id
		invoiceView.Payment_status = invoice.Payment_status
		invoiceView.Payment_due = allOrderItems[0]["paymet_due"]
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprint("message: invoice not found")
		...
		result, insertErr := invoiceCollection.InsertOne(ctx, order)
